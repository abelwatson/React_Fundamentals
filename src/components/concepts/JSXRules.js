        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <dl>
                    ...
                    <dd>These are used to construct and update the DOM, or what y
                        ou see on the screen.</dd>
                    <dt>Not required</dt>
...
const CreateElementComponent = () => {
    return (
        ...
        React.createElement('p', null, 'This was constructed with createElement() in the return '), React.createElement('img', { src: 'https://cdn-images-1.medium.com/max/1200/1*jJZHFQmhkq_7ohn18KrMhA.png' }, null)
        )
    );
};
